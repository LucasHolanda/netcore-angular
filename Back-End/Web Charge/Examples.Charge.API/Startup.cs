...
namespace Examples.Charge.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                // Projeto também esta funcionando utilizando container do Docker, Basta trocar a ConnectionString 'DefaultConnection'
                options.UseSqlServer(Configuration.GetConnectionString("LocalConnection"));
                options.UseSqlServer(Configuration.GetConnectionString("LocalConnection"), b => b.MigrationsAssembly("Examples.Charge.Infra.Data.Configuration"));
            });
